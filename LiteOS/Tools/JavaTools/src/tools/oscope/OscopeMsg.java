...
public class OscopeMsg extends tools.message.Message {

    /** The default size of this message type in bytes. */
    public static final int DEFAULT_MESSAGE_SIZE = 26;

    /** The Active Message type associated with this message. */
    public static final int AM_TYPE = 01;
     ...
     */
    public OscopeMsg(tools.message.Message msg, int base_offset) {
     ...
     */
    public OscopeMsg(tools.message.Message msg, int base_offset, int data_length) {
