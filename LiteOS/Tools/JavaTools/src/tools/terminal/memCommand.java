    ...
    public void handleresponse(String[] options, int optioncount, String [] parameters, int parametercount, ArrayList reply ,fileDirectory fdir) {
       ...
       // for (int start = 0; start + 32 <= length; start += 32) {
        while (reply.size() > 0)
        {
            ...
            appromstart = (0x000000FF & ((int) response[start+lenoffilename + 9])) * 256 +  (0x000000FF & ((int) response[start+lenoffilename + 10])) ;
            appromstart = appromstart *2;
            appromsize =  (0x000000FF & ((int) response[start+lenoffilename + 11])) * 256 +  (0x000000FF & ((int) response[start+lenoffilename + 12])) ;
            appramstart = (0x000000FF & ((int) response[start+lenoffilename + 13])) * 256 +  (0x000000FF & ((int) response[start+lenoffilename + 14])) ;
