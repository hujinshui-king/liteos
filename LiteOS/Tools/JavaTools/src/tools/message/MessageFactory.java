...
public class MessageFactory {
	...
	cArgs[0] = Integer.TYPE; cArgs[1] = Integer.TYPE;
	return instantiateTOSMsg(cArgs, initArgs); 
    }
    ...
    public TOSMsg createTOSMsg(tools.message.Message msg, int base_offset, int data_length) {
	Object initArgs[] = new Object[3];
	Class cArgs[] = new Class[3];
	initArgs[0] = msg;
	initArgs[1] = new Integer(base_offset);
	...
	try { 
	    ...
	    } else if (pSource != null){ // we got instantiated with a concrete source
		msgCls = Class.forName("tools.message."+
	    ...
	    System.err.println("Could not locate the appropriate constructor; check the class "+"tools.message."+
