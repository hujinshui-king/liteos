// $Id: BaseTOSMsg.java,v 1.5 2003/10/07 21:45:57 idgay Exp $
...
public class BaseTOSMsg extends tools.message.Message {
     ...
     */
    public BaseTOSMsg(tools.message.Message msg, int base_offset, int data_length) {
    ...
    public String getString_data() { 
         char carr[] = new char[Math.min(tools.message.Message.MAX_CONVERTED_STRING_LENGTH,29)];
         int i;
