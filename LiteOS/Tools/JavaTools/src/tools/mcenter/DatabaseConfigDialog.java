...
import tools.mcenter.treeTable.*;
...
public class DatabaseConfigDialog extends javax.swing.JDialog {
	...
	public DatabaseConfigDialog(java.awt.Frame parent, boolean modal) {
		...
		/*
		 * try{ localModel = new
		 * PreferenceModel(Class.forName("isis.nest.messageCenter.CenterFrame"
		 * )); }catch(java.lang.ClassNotFoundException cnfe){
		 * System.err.println("Class not Found"); localModel = new
		 * PreferenceModel(); }
		 */
	...
	private void reloadButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN
																				// -
																				// FIRST
																				// :
																				// event_reloadButtonActionPerformed
		/*
		 * try{ localModel = new
		 * PreferenceModel(Class.forName("isis.nest.messageCenter.CenterFrame"
		 * )); }catch(java.lang.ClassNotFoundException cnfe){
	...
	private void importButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN
		...
		// try{
		if (importModel != null)
			((XmlPreferenceModel) importModel).importSelection(Preferences
					.userRoot());
		/*
		 * }catch(java.lang.ClassNotFoundException cnfe){
	...
	private void openButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN
																			...
																			// FIRST
																			// :
																			// event_openButtonActionPerformed
		...
		if (returnVal == javax.swing.JFileChooser.APPROVE_OPTION) {
			...
			if (!getExtension(selectedFile).equalsIgnoreCase("xml")) {
				System.out.println("Cannot import choosen file: "
			...
			// indicates a well-formedness error
				...
				System.err.println("Cannot read file: "
						+ selectedFile.getAbsolutePath());
				System.out.println("Could not check " + selectedFile
	...
	private void exportButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN
		...
		if (returnVal == javax.swing.JFileChooser.APPROVE_OPTION) {
			...
			if (!getExtension(selectedFile).equalsIgnoreCase("xml"))
				selectedFile = new java.io.File(selectedFile.getParent(),
						selectedFile.getName() + ".xml");

			System.out.println("You've choosen to save into this file: "
					+ selectedFile.getName());

			try {
				localModel.exportSelection(new java.io.FileOutputStream(
						selectedFile));
			} catch (java.io.FileNotFoundException fnfe) {
				System.err.println("Cannot open file: "
						+ selectedFile.getAbsolutePath());
